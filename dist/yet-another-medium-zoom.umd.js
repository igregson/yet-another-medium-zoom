(function(global, factory) {
    ...
    ***************************************************************************** */
    ...
    function getTransform(from, to) {
        ...
        var translation =
            "translate(" + delta.left.toFixed(5) + "px, " + delta.top.toFixed(5) + "px)";
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            $animElm =
                                this.active.$copiedImg.parentElement || this.active.$copiedImg;
                            $positionElm =
    ...
    var css$3 =
        ".yamz__wrapper:not(.yamz__wrapper--closing) .yamz__img-wrapper--swiping {\n    transition: none !important;\n    will-change: transform;\n}\n";
    styleInject(css$3);
    ...
    function withSwipe(_yamz) {
        ...
        yamz.applySwipeTransform = function(touchOffset, opts) {
            ...
            if (opts.swipeResponseLimit) {
                ...
                var linearOffset =
                    Math.abs(touchOffset.x) - Math.min(Math.abs(touchOffset.x), limit);
